...
const practiseUseOne = () => {
  ...
  return (
    <SafeAreaView>
      {/* <TestOneComponent/> */}
      <Text onPress={apiCalling}>practiseUseOne</Text>
      <Text onPress={increaseCount}>count</Text>
      <FlatList data={dataApi} renderItem={renderitem} />
      {/* <ScrollView>
        {dataApi.map((item,index)=>renderitem(item,index))}
      </ScrollView> */}
    </SafeAreaView>
  );
};

export default practiseUseOne;
